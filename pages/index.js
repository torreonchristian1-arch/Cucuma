...
const PRODUCTS = [
  { name: "Rose Glow Serum", cat: "Skincare", price: "$22.99", img: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=400&q=80" },
  { name: "Matte Lip Studio", cat: "Cosmetics", price: "$13.59", img: "https://images.unsplash.com/photo-1586495777744-4e6232bf4e45?w=400&q=80" },
  { name: "Keratin Repair Mask", cat: "Haircare", price: "$37.49", img: "https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?w=400&q=80" },
...
const STEPS = [
  ...
  { n: "02", title: "Design Your Brand", desc: "Upload your logo, choose your colors, and customize your label. Your brand identity applied instantly to every product.", img: "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab12?w=600&q=85" },
  { n: "03", title: "Launch & Scale", desc: "Publish to Shopify with one click. We print, pack, and ship every order directly to your customers.", img: "https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=600&q=85" },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Design your label, publish to Shopify, sell with zero inventory." />
      ...
      <section className="hero" id="hero">
        <div>
          <div style={{ ...a(0), display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 32 }}>
            <span className="hero-badge"><span className="hero-badge-dot"></span>Now Live · Private Label Beauty</span>
          </div>
          ...
          <p className="hero-sub" style={a(220)}>Design your label, publish to Shopify, and start selling — with zero upfront inventory. We print, pack, and ship every order.</p>
      ...
      <section className="section" style={{ background: "white" }}>
        <Reveal><div style={{ textAlign: "center", marginBottom: 56 }}><div className="section-lbl">Why Cucuma</div><h2 className="section-title">Everything You Need<br /><em>to Build a Real Brand</em></h2></div></Reveal>
        <div className="values-grid">
          {[{ icon: "🛡️", title: "Zero Inventory Risk", desc: "Never buy stock upfront. We print and ship only when a customer orders." }, { icon: "✦", title: "Your Brand, Your Rules", desc: "Your logo and colors on every product. Complete brand ownership." }, { icon: "🚀", title: "Fast Global Shipping", desc: "Most orders delivered in 3-5 business days. Express options available." }, { icon: "💰", title: "100% Profits Yours", desc: "Set your own prices. Pay wholesale cost per unit. Keep everything above that." }].map((v, i) => (
